...
const Navbar = () => {
  ...
  return (
    <Grid className={styles.navbar} container>
      ...
      <Grid container display={'flex'} alignItems={'center'} justifyContent={'flex-end'} item md={8} sm={12}>
        <Grid className='col-center' item>
          <div className={styles.navItems}>
            <div className={styles.navItem}>
              ...
              <NavDropDown width={'600px'} image={about5} items={aboutUsItems} buttons={aboutUsbuttons} />
            </div>
