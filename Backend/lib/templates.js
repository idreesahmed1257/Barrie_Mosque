...
export const getBusinessApprovalTemplate = (data) => {
    return `
    <div style="font-family: Arial, sans-serif; border: 1px solid #d4edda; background-color: #f6fffa; padding: 20px; border-radius: 5px;">
        <h2 style="color: #155724;">New Business Approval Request</h2>
        <p>A new business has been submitted for approval:</p>
        ...
        <p style="margin-top: 20px;">Please review and approve the business in the admin dashboard.</p>
    </div>
    `;
};
